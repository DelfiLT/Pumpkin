...
public class gameManagerTutorial : MonoBehaviour
{
    ...
    private string[] dialog_text = {"Welcome, I will show you how to play this game",
                                    ...
                                    "First we need to set our position over a cave (you can search them with the zoom)",
                                    ...
                                    "Perfect!, now, go back to the seed and water it with E key",
                                    "Fantastic!, to make the pumpkin grows, collect more water drops and ...",
                                    "water the pumpkin until you see the roots below it",
